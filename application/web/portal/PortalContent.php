    ...
    public static function texts(string $code): array
    {
        $texts = [
            'mn' => [
                ...
                'why_lead' => 'Хэрэглэгчийн эрх, олон хэл, CMS, дэлгүүр, лог, кэш - үйлдвэрлэлийн сайтад хэрэгтэй бүх зүйл нэг дор, харин код нь бүхэлдээ таны мэдэлд.',
