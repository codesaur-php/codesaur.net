...
1. **Raptor анхдагч байдлаар session cookie-ийн хугацааг 30 хоног болгодог** - нэвтэрсэн админы session-ийг удаан хадгалахын тулд `SessionMiddleware` дотроос `session_set_cookie_params(...)`-аар тохируулдаг. Энэ нь зөвхөн client талын cookie бөгөөд админ browser-ээ хаагаад дахин нээсэн ч нэвтэрсэн хэвээр үлдэнэ.
