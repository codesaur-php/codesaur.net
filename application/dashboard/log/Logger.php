...
/**
 * Logger - PSR-3 стандарт дээр суурилсан Raptor-ийн лог бичигч.
 *
 * Онцлог:
 * -------------------------------------------------------------------
...
class Logger extends AbstractLogger
{
     ...
     *
     * Хүснэгт шинээр үүсэх үед created_at багана дээр индекс үүсгэнэ.
     * Энэ нь dashboard статистик, лог хайлт зэрэг огнооны range query-г
     * full table scan-гүйгээр хурдан гүйцэтгэх боломж олгоно.
     *
     * Энэ хүснэгт нь "append-only" event log тул:
     *   * FK (гадаад түлхүүр) шаардлагагүй - лог нь бусад хүснэгтээс хараат бус
     *   * Seed / анхны өгөгдөл хэрэггүй
     *   * FK тавихгүй учир нь хэрэглэгч, контент устах үед лог устах эрсдэлтэй
     *
     * @return void
     */
     ...
     *
     *  Security (English): log files and log tables can leak (backups,
     *  unauthorized reads), so sensitive keys like PASSWORD/TOKEN/JWT/PIN are
     *  automatically masked as "*** hidden ***" before serialization - never
     *  allow them to be stored in plain text.
     */
