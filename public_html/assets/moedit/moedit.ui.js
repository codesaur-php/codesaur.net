    ...
    <div class="moedit-modal">
      ...
      <div style="padding: 15px 0;">
        ...
        <ul style="margin-bottom: 15px; padding-left: 20px; color: var(--mo-placeholder); font-size: 13px;">
          ...
          <li style="margin-bottom: 6px;"><code style="background: var(--mo-bg-muted, #f5f5f5); padding: 2px 6px; border-radius: 3px;">RAPTOR_OPENAI_API_KEY</code> - ${this._isMn ? 'Backend дээр OpenAI API key тохируулах' : 'Set OpenAI API key on backend'}</li>
        </ul>
