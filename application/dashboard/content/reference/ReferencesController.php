 ...
 */
class ReferencesController extends \Dashboard\Controller
{
    ...
    public function index()
    {
        ...
        $this->log('content', LogLevel::NOTICE, 'Лавлах хүснэгтүүдийн жагсаалтыг үзэж байна', ['action' => 'reference-index']);
    }
