 ...
 *
 * system_coder-ийн хандах эрх энэ хүснэгтээс хамаардаггүй: coder бол
 * cross-tenant superuser тул бүх идэвхтэй байгууллагад гишүүнчлэлийн
 * мөргүйгээр ордог. (Гишүүнчлэлийн мөр нь coder-т ч бас байдаг - seed нь
 * coder-ийг системийн байгууллагад бүртгэдэг, шинэ coder ч ихэвчлэн
 * бүртгэлтэй байдаг - гэхдээ тэр мөр нь хандалтын нөхцөл биш.)
 * JWTAuthMiddleware байгууллага шалгахдаа хоёр замаар салдаг:
 *  - coder: энэ хүснэгтийг огт харахгүй, зорьсон байгууллага нь зөвхөн
 *    идэвхтэй (is_active=1) байхыг л шаардана. Хандах эрх нь рольоос
 *    гарч ирдэг тул хуурамч гишүүнчлэлийн мөр нэмэгдэхгүй - role хасагдвал
 *    хандалт нь өөрөө хаагдана (эрхийн үлдэгдэл үүсэхгүй).
 *  - энгийн хэрэглэгч: энэ хүснэгтэд тухайн байгууллагатай холбосон мөр
 *    заавал байх ёстой (үгүй бол 406).
 *
 * Үндсэн боломжууд:
