            ...
            'raptor' => [
                ...
                'features' => [
                    'mn' => [
                        ...
                        'Олон хэл дэмжлэг (Localization) - хэл бүр URL prefix-тэй (/en/...), canonical + hreflang автоматаар',
                        'Бүх хэлэнд нэг дор харагдах бичлэг (code = "*") - мэдээ, хуудас, бүтээгдэхүүнд',
                    ...
                    'en' => [
                        ...
                        'Multi-language support (Localization) - one URL prefix per language (/en/...), canonical + hreflang emitted automatically',
                        'Language-neutral records (code = "*") shown in every language - news, pages and products',
